...
'''
This code train the model with batch normalization
'''

# *********  Setting part  (replace that with suitable setting from configs.txt) ********

configs = {'MODEL_NAME': "./models/model_bn.hdf5", 'VALIDATION_RATIO': 0.2,
           'TOTAL_NUM_TRAINING': 37120, 'TOTAL_NUM_VALIDATION': 9280,
           'learning_rate': 1e-4, 'epochs': 50, 'batch_size': 16, 'alpha': 0.5,
           'nfs': [8, 16, 32, 64, 64, 64, 32, 16, 8, 32], 'kss': [5, 5, 3, 3],
           'dense_num': 32, 'l2_reg': [1e-6, 1e-4], 'mse_factor': 0.01, 'spearman_factor': 0.1,
...
pretrained_weights = './pretrained_models/model_bn_pretrained_h5.hdf5'
